...
public partial class user : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[Association(Name="user_ticket", Storage="_tickets", OtherKey="submitter")]
	...
	[Association(Name="user_comment", Storage="_comments", OtherKey="submitter")]
	...
	[Association(Name="sub_unit_user", Storage="_sub_unit1", ThisKey="sub_unit", IsForeignKey=true)]
...
public partial class priority : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[Association(Name="priority_ticket", Storage="_tickets", OtherKey="priority")]
	public EntitySet<ticket> tickets
	{
		get
		{
	...
	[Association(Name="priority_comment", Storage="_comments", OtherKey="priority_id")]
	public EntitySet<comment> comments
	{
		get
		{
...
public partial class security_level : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[Association(Name="security_level_sub_unit", Storage="_sub_units", OtherKey="access_level")]
	...
	[Association(Name="security_level_user_group", Storage="_user_groups", OtherKey="security_level")]
...
public partial class statuse : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[Association(Name="statuse_ticket", Storage="_tickets", OtherKey="ticket_status")]
	public EntitySet<ticket> tickets
	{
		get
		{
	...
	[Association(Name="statuse_comment", Storage="_comments", OtherKey="status_id")]
	public EntitySet<comment> comments
	{
		get
		{
...
public partial class sub_unit : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[Association(Name="sub_unit_user", Storage="_users", OtherKey="sub_unit")]
	...
	[Association(Name="sub_unit_ticket", Storage="_tickets", OtherKey="assigned_to_group")]
	public EntitySet<ticket> tickets
	{
		get
		{
	...
	[Association(Name="sub_unit_ticket1", Storage="_tickets1", OtherKey="assigned_to_group_last")]
	...
	[Association(Name="sub_unit_ticket2", Storage="_tickets2", OtherKey="originating_group")]
	...
	[Association(Name="sub_unit_comment", Storage="_comments", OtherKey="assigned_to")]
	public EntitySet<comment> comments
	{
		get
		{
	...
	[Association(Name="security_level_sub_unit", Storage="_security_level", ThisKey="access_level", IsForeignKey=true)]
	...
	[Association(Name="unit_sub_unit", Storage="_unit", ThisKey="unit_ref", IsForeignKey=true)]
	public unit unit
	{
		get
		{
...
public partial class unit : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[Association(Name="unit_sub_unit", Storage="_sub_units", OtherKey="unit_ref")]
	public EntitySet<sub_unit> sub_units
	{
		get
		{
...
public partial class user_group : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[Association(Name="security_level_user_group", Storage="_security_level1", ThisKey="security_level", IsForeignKey=true)]
...
public partial class ticket : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[Association(Name="ticket_comment", Storage="_comments", OtherKey="ticket_ref")]
	public EntitySet<comment> comments
	{
		get
		{
	...
	[Association(Name="ticket_attachment", Storage="_attachments", OtherKey="ticket_ref")]
	...
	[Association(Name="sub_unit_ticket", Storage="_sub_unit", ThisKey="assigned_to_group", IsForeignKey=true)]
	...
	[Association(Name="sub_unit_ticket1", Storage="_sub_unit1", ThisKey="assigned_to_group_last", IsForeignKey=true)]
	public sub_unit sub_unit1
	{
		get
		{
	...
	[Association(Name="sub_unit_ticket2", Storage="_sub_unit2", ThisKey="originating_group", IsForeignKey=true)]
	...
	[Association(Name="priority_ticket", Storage="_priority1", ThisKey="priority", IsForeignKey=true)]
	...
	[Association(Name="user_ticket", Storage="_user", ThisKey="submitter", IsForeignKey=true)]
	public user user
	{
		get
		{
	...
	[Association(Name="statuse_ticket", Storage="_statuse", ThisKey="ticket_status", IsForeignKey=true)]
...
public partial class comment : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[Association(Name="comment_attachment", Storage="_attachments", OtherKey="comment_ref")]
	public EntitySet<attachment> attachments
	{
		get
		{
	...
	[Association(Name="sub_unit_comment", Storage="_sub_unit", ThisKey="assigned_to", IsForeignKey=true)]
	public sub_unit sub_unit
	{
		get
		{
	...
	[Association(Name="priority_comment", Storage="_priority", ThisKey="priority_id", IsForeignKey=true)]
	...
	[Association(Name="statuse_comment", Storage="_statuse", ThisKey="status_id", IsForeignKey=true)]
	public statuse statuse
	{
		get
		{
	...
	[Association(Name="user_comment", Storage="_user", ThisKey="submitter", IsForeignKey=true)]
	public user user
	{
		get
		{
	...
	[Association(Name="ticket_comment", Storage="_ticket", ThisKey="ticket_ref", IsForeignKey=true)]
...
public partial class attachment : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[Association(Name="comment_attachment", Storage="_comment", ThisKey="comment_ref", IsForeignKey=true)]
	...
	[Association(Name="ticket_attachment", Storage="_ticket", ThisKey="ticket_ref", IsForeignKey=true)]
	public ticket ticket
	{
		get
		{
