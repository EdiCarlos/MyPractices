...
namespace Crom.Controls.Test
{
    ...
    public class DockTest : Form
    {
        ...
        private void Initialize()
        {
            ...
            Form form5 = CreateTestForm(700, 100, 200, 150, Color.AliceBlue, "Form 5");
            ...
            Crom.Controls.Test.Forms.MyLoginForm mylogin = new Crom.Controls.Test.Forms.MyLoginForm();
            ...
            DockableFormInfo info5 = _docker.Add(mylogin, zAllowedDock.Vertically, Guid.NewGuid());
            ...
            _docker.DockForm(info5, DockStyle.Bottom, zDockMode.Outer);
