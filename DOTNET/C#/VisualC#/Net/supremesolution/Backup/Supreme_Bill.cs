...
{
    public partial class Supreme_Bill : Form
    {
        public Supreme_Bill()
        {
            InitializeComponent();
        ...
        private void dataGridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            dtBilMain.Text = DateTime.Parse(dataGridView1.CurrentRow.Cells["billdateDataGridViewTextBoxColumn"].Value.ToString()).ToShortDateString();
            ...
            MainBillId = int.Parse(dataGridView1.CurrentRow.Cells["mnbillidDataGridViewTextBoxColumn"].Value.ToString());
            this.billTableAdapter.FillBy(this.maindataset.bill, new System.Nullable<int>(((int)(System.Convert.ChangeType(dataGridView1.CurrentRow.Cells["mnbillIdDataGridViewTextBoxColumn"].Value.ToString(), typeof(int))))));

            dataGridView2.DataSource = this.maindataset.bill;
        ...
        {
            dtcol1row7.Text = DateTime.Parse(dataGridView2.Rows[j].Cells["billdateDataGridViewTextBoxColumn1"].Value.ToString()).ToShortDateString();
            ...
            txtTataBillCol11Row7.Text = dataGridView2.Rows[j].Cells["billnumberDataGridViewTextBoxColumn"].Value.ToString();
            BillId7 = int.Parse(dataGridView2.Rows[j].Cells["billidDataGridViewTextBoxColumn1"].Value.ToString());

        }

        private void FillRow7(int j)
        {
            dtcol1row6.Text = DateTime.Parse(dataGridView2.Rows[j].Cells["billdateDataGridViewTextBoxColumn1"].Value.ToString()).ToShortDateString();
            ...
            txtTataBillCol11Row6.Text = dataGridView2.Rows[j].Cells["billnumberDataGridViewTextBoxColumn"].Value.ToString();
            BillId6 = int.Parse(dataGridView2.Rows[j].Cells["billidDataGridViewTextBoxColumn1"].Value.ToString());

        }

        private void FillRow6(int j)
        {
            dtcol1row5.Text = DateTime.Parse(dataGridView2.Rows[j].Cells["billdateDataGridViewTextBoxColumn1"].Value.ToString()).ToShortDateString();
            ...
            txtTataBillCol11Row5.Text = dataGridView2.Rows[j].Cells["billnumberDataGridViewTextBoxColumn"].Value.ToString();
            BillId5 = int.Parse(dataGridView2.Rows[j].Cells["billidDataGridViewTextBoxColumn1"].Value.ToString());
        }

        private void FillRow5(int j)
        {
            dtcol1row4.Text = DateTime.Parse(dataGridView2.Rows[j].Cells["billdateDataGridViewTextBoxColumn1"].Value.ToString()).ToShortDateString();
            ...
            txtTataBillCol11Row4.Text = dataGridView2.Rows[j].Cells["billnumberDataGridViewTextBoxColumn"].Value.ToString();
            BillId4 = int.Parse(dataGridView2.Rows[j].Cells["billidDataGridViewTextBoxColumn1"].Value.ToString());
        }

        private void FillRow4(int j)
        {
            dtcol1row3.Text = DateTime.Parse(dataGridView2.Rows[j].Cells["billdateDataGridViewTextBoxColumn1"].Value.ToString()).ToShortDateString();
            ...
            txtTataBillCol11Row3.Text = dataGridView2.Rows[j].Cells["billnumberDataGridViewTextBoxColumn"].Value.ToString();
            BillId3 = int.Parse(dataGridView2.Rows[j].Cells["billidDataGridViewTextBoxColumn1"].Value.ToString());
        }

        private void FillRow3(int j)
        {
            dtcol1row2.Text = DateTime.Parse(dataGridView2.Rows[j].Cells["billdateDataGridViewTextBoxColumn1"].Value.ToString()).ToShortDateString();
            ...
            txtTataBillCol11Row2.Text = dataGridView2.Rows[j].Cells["billnumberDataGridViewTextBoxColumn"].Value.ToString();
            BillId2 = int.Parse(dataGridView2.Rows[j].Cells["billidDataGridViewTextBoxColumn1"].Value.ToString());
        }

        private void FillRow2(int j)
        {

            dtcol1row1.Text = DateTime.Parse(dataGridView2.Rows[j].Cells["billdateDataGridViewTextBoxColumn1"].Value.ToString()).ToShortDateString();
            ...
            txtTataBillCol11Row1.Text = dataGridView2.Rows[j].Cells["billnumberDataGridViewTextBoxColumn"].Value.ToString();
            BillId1 = int.Parse(dataGridView2.Rows[j].Cells["billidDataGridViewTextBoxColumn1"].Value.ToString());

        }

        private void FillRow1(int j)
        {
            dtcol1row0.Text = DateTime.Parse(dataGridView2.Rows[j].Cells["billdateDataGridViewTextBoxColumn1"].Value.ToString()).ToShortDateString();
            ...
            txtTataBillCol11Row0.Text = dataGridView2.Rows[j].Cells["billnumberDataGridViewTextBoxColumn"].Value.ToString();
            BillId0 = int.Parse(dataGridView2.Rows[j].Cells["billidDataGridViewTextBoxColumn1"].Value.ToString());
        }
        #endregion
        ...
        {
            get { return bags; }
            set { bags = value != String.Empty ? value : "0"; }
        }
        public string Goods
        {
            get { return goods; }
        ...
        private int InsertDataInMainBill()
        {
            ...
            try
            {
                rows = this.mainbillTableAdapter.Insert(UserLogin.UserId, 0, BillNumber, BillDate, PartyName, Station, Total, ServiceCharge, SurCharge, HsServiceCharge, Tax, null, null, null, EndDate, Totalinwords, Totalbags, Totaltones);
            }
        ...
        private int InsertDataInBill()
        {
            ...
            InitializeRow1();
            int rows = this.billTableAdapter.Insert(billid, 100, LoadingDate, GcNumber, ChalanNumber, TruckNumber, Goods, Bags, Tone, Rate, Amount, UnloadingDate, Tatabill);

            //Initializing 2nd row
            InitializeRow2();

            rows += this.billTableAdapter.Insert(billid, 100, LoadingDate, GcNumber, ChalanNumber, TruckNumber, Goods, Bags, Tone, Rate, Amount, UnloadingDate, Tatabill);
        ...
        private void InitializeRow8()
        {
            ...
            Tatabill = txtTataBillCol11Row7.Text.Trim();
        ...
        private void InitializeRow7()
        {
            ...
            Tatabill = txtTataBillCol11Row6.Text.Trim();
        ...
        private void InitializeRow6()
        {
            ...
            Amount = decimal.Parse(txtAmountCol9Row2.Text == String.Empty ? "0" : txtAmountCol9Row5.Text);
            UnloadingDate = DateTime.Parse(dtUlDateCol10Row5.Text == String.Empty ? new DateTime(2010, 01, 01).ToString() : dtUlDateCol10Row5.Text);
            Tatabill = txtTataBillCol11Row5.Text.Trim();
        ...
        private void InitializeRow5()
        {
            ...
            Tatabill = txtTataBillCol11Row4.Text.Trim();
        ...
        private void InitializeRow4()
        {
            ...
            Tatabill = txtTataBillCol11Row3.Text.Trim();
        ...
        private void InitializeRow3()
        {
            ...
            Tatabill = txtTataBillCol11Row2.Text.Trim();
        ...
        private void InitializeRow2()
        {
            ...
            Tatabill = txtTataBillCol11Row1.Text.Trim();
        ...
        private void InitializeRow1()
        {
            ...
            Tatabill = txtTataBillCol11Row0.Text.Trim();
        }
        #endregion
        ...
        {
            //int mnrowsaffected = this.mainbillTableAdapter.Insert(100, 100, 615, DateTime.Now, "Tata chemical ltd", "taluja", 34770, 8518, 170, 85, 8773, null, null, null);
            ...
            if (CheckMainFields(ref message))
            {
                ...
                {
                    this.mainbillTableAdapter.Fill(this.maindataset.mainbill);
                    dataGridView1.DataSource = this.maindataset.mainbill;
                }
            }
            else
            {
        ...
        private int UpdateMainBill()
        {
            ...
            int retVal = this.mainbillTableAdapter.FillBy(this.maindataset.mainbill, UserLogin.UserId, billid, BillNumber, BillDate, PartyName, Station, Total, ServiceCharge, SurCharge, HsServiceCharge, Tax, Totalinwords, Totalbags, Totaltones, MainBillId);
        ...
        private int UpdateBill()
        {
            ...
            int retVal = this.billTableAdapter.FillByBill(this.maindataset.bill, BillId0, userid, MainBillId, LoadingDate, GcNumber, ChalanNumber, TruckNumber, Goods, Bags, Tone, Rate, Amount, UnloadingDate, Tatabill);

            InitializeRow2();

            retVal += this.billTableAdapter.FillByBill(this.maindataset.bill, BillId1, userid, MainBillId, LoadingDate, GcNumber, ChalanNumber, TruckNumber, Goods, Bags, Tone, Rate, Amount, UnloadingDate, Tatabill);

            InitializeRow3();

            retVal += this.billTableAdapter.FillByBill(this.maindataset.bill, BillId2, userid, MainBillId, LoadingDate, GcNumber, ChalanNumber, TruckNumber, Goods, Bags, Tone, Rate, Amount, UnloadingDate, Tatabill);

            InitializeRow4();

            retVal += this.billTableAdapter.FillByBill(this.maindataset.bill, BillId3, userid, MainBillId, LoadingDate, GcNumber, ChalanNumber, TruckNumber, Goods, Bags, Tone, Rate, Amount, UnloadingDate, Tatabill);

            InitializeRow5();

            retVal += this.billTableAdapter.FillByBill(this.maindataset.bill, BillId4, userid, MainBillId, LoadingDate, GcNumber, ChalanNumber, TruckNumber, Goods, Bags, Tone, Rate, Amount, UnloadingDate, Tatabill);

            InitializeRow6();

            retVal += this.billTableAdapter.FillByBill(this.maindataset.bill, BillId5, userid, MainBillId, LoadingDate, GcNumber, ChalanNumber, TruckNumber, Goods, Bags, Tone, Rate, Amount, UnloadingDate, Tatabill);

            InitializeRow7();

            retVal += this.billTableAdapter.FillByBill(this.maindataset.bill, BillId6, userid, MainBillId, LoadingDate, GcNumber, ChalanNumber, TruckNumber, Goods, Bags, Tone, Rate, Amount, UnloadingDate, Tatabill);

            InitializeRow8();

            retVal += this.billTableAdapter.FillByBill(this.maindataset.bill, BillId7, userid, MainBillId, LoadingDate, GcNumber, ChalanNumber, TruckNumber, Goods, Bags, Tone, Rate, Amount, UnloadingDate, Tatabill);
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                this.mainbillTableAdapter.FillByMainSearch(maindataset.mainbill, PartyName, Station, BillNumber, BillDate);
            }
            else if (txtPartyName.Text.Length != 0 & txtStation.Text.Length != 0)
            {
                this.mainbillTableAdapter.FillByMainSearchPartyAndStation(maindataset.mainbill, PartyName, Station);
            }
            else if (txtPartyName.Text.Length != 0 & txtStation.Text.Length != 0 & txtDebitBillNo.Text.Length != 0)
            {
                this.mainbillTableAdapter.FillByMainSearchPartyStationAndDbno(maindataset.mainbill, PartyName, Station, BillNumber);
            }
            else if (txtPartyName.Text.Length != 0)
            {
                this.mainbillTableAdapter.FillByMainSearchPartyName(this.maindataset.mainbill, PartyName);
            }
            else if (txtDebitBillNo.Text.Length != 0)
            {
                this.mainbillTableAdapter.FillByMainSearchDebitBillNo(this.maindataset.mainbill, BillNumber);
            }
            else if (dtBilMain.Text.Length != 0)
            {
                this.mainbillTableAdapter.FillMainSearchByBillDate(this.maindataset.mainbill, BillDate);
            }
            else if (txtStation.Text.Length != 0)
            {
                this.mainbillTableAdapter.FillByMainSearchStation(this.maindataset.mainbill, Station);
            }
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                this.mainbillTableAdapter.FillBydeleteMain(this.maindataset.mainbill, mainBillId);
                dataGridView1.DataSource = this.maindataset.mainbill;
                this.billTableAdapter.FillBy(this.maindataset.bill, new System.Nullable<int>(((int)(System.Convert.ChangeType(dataGridView1.CurrentRow.Cells["mnbillIdDataGridViewTextBoxColumn"].Value.ToString(), typeof(int))))));
                dataGridView2.DataSource = this.maindataset.bill;
                ClearMainFields();
        ...
        string FillAmountMessage = "Please Fill The Tones Value First For Proper Calculation";
        ...
        private void FillAmountRow7(TextEdit txt)
        {
            ...
            {
                MessageBox.Show(FillAmountMessage);
        ...
        #region Check box event to show all bills
        private void checkshowAllbox_CheckedChanged(object sender, EventArgs e)
        {
            if (checkshowAllbox.Checked == true)
            {
                this.mainbillTableAdapter.FillBySelectAll(maindataset.mainbill);
            ...
            {
                this.mainbillTableAdapter.Fill(maindataset.mainbill);
        ...
        private void viewReport_Click(object sender, EventArgs e)
        {
            ...
            SupremeMainBillCrystalReport supremeReport = new SupremeMainBillCrystalReport(MainBillId);
            supremeReport.Show();
        ...
        {
            PrintingClass print = new PrintingClass(MainBillId);
